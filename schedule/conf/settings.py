...
try:
    ...
    raise ImproperlyConfigured('FIRST_DAY_OF_WEEK must be an integer between 0'
                               ' and 6')
...
# (e.g. all events on that calendar, those events plus another calendar's
# events, or the events filtered based on user permissions) Imports have to be
# placed within the function body to avoid circular imports
...
OCCURRENCE_CANCEL_REDIRECT = getattr(settings, 'OCCURRENCE_CANCEL_REDIRECT',
                                     None)
