...
import django.contrib.syndication.views.feed
...
urlpatterns = patterns('schedule.views',
    # urls for Calendars
    url(r'^calendar/$', object_list, name='schedule', kwargs={
        'queryset': Calendar.objects.all(),
        'template_name': 'schedule/calendar_list.html'
    }),
    url(r'^calendar/year/(?P<calendar_slug>[-\w]+)/$', 'calendar_by_periods',
        name='year_calendar', kwargs={
        'periods': [Year],
        'template_name': 'schedule/calendar_year.html'
    }),
    url(r'^calendar/tri_month/(?P<calendar_slug>[-\w]+)/$',
        'calendar_by_periods', name='tri_month_calendar', kwargs={
        'periods': [Month],
        'template_name': 'schedule/calendar_tri_month.html'
    }),
    url(r'^calendar/compact_month/(?P<calendar_slug>[-\w]+)/$',
        'calendar_by_periods', name='compact_calendar', kwargs={
        'periods': [Month],
        'template_name': 'schedule/calendar_compact_month.html'
    }),
    url(r'^calendar/month/(?P<calendar_slug>[-\w]+)/$', 'calendar_by_periods',
        name='month_calendar', kwargs={
        'periods': [Month],
        'template_name': 'schedule/calendar_month.html'
    }),
    url(r'^calendar/week/(?P<calendar_slug>[-\w]+)/$', 'calendar_by_periods',
        name='week_calendar', kwargs={
        'periods': [Week],
        'template_name': 'schedule/calendar_week.html'
    }),
    url(r'^calendar/daily/(?P<calendar_slug>[-\w]+)/$', 'calendar_by_periods',
        name='day_calendar', kwargs={
        'periods': [Day],
        'template_name': 'schedule/calendar_day.html'
    }),
    url(r'^calendar/(?P<calendar_slug>[-\w]+)/$', 'calendar',
        name='calendar_home'),
    ...
    url(r'^event/(?P<event_id>\d+)/$', 'schedule.views.event', name='event'),
    ...
    url(r'^occurrence/(?P<event_id>\d+)/(?P<year>\d+)/(?P<month>\d+)/'
        '(?P<day>\d+)/(?P<hour>\d+)/(?P<minute>\d+)/(?P<second>\d+)/$',
        'occurrence', name='occurrence_by_date'),
    url(r'^occurrence/cancel/(?P<event_id>\d+)/(?P<year>\d+)/(?P<month>\d+)/'
        '(?P<day>\d+)/(?P<hour>\d+)/(?P<minute>\d+)/(?P<second>\d+)/$',
        'cancel_occurrence', name='cancel_occurrence_by_date'),
    url(r'^occurrence/edit/(?P<event_id>\d+)/(?P<year>\d+)/(?P<month>\d+)/'
        '(?P<day>\d+)/(?P<hour>\d+)/(?P<minute>\d+)/(?P<second>\d+)/$',
